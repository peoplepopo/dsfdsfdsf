...
(function(root, undefined){
    ...
    HSHG.prototype.queryForCollisionPairs = function(possibleCollisions/*,broadOverlapTestCallback*/){
        var i, j, k, l, c
            ,grid
            ,cell
            ,objA
    ...
    Grid.prototype.initCells = function(){
        ...
        for(i = 0; i < gridLength; i++){
            ...
            if(isOnRightEdge || isOnLeftEdge || isOnTopEdge || isOnBottomEdge){
                ...
                rightOffset = isOnRightEdge ? -wh + 1 : 1;
                leftOffset = isOnLeftEdge ? wh - 1 : -1;
                topOffset = isOnTopEdge ? -gridLength + wh : wh;
                bottomOffset = isOnBottomEdge ? gridLength - wh : -wh;
